...
const game = {
    ...
    initializeEvents() {
        ...
        this.events = [
            ...
            new GameEvent('robber', "인적이 드문 뒷골목을 지나가다 노상강도를 마주쳤습니다!", [ new StatCheckChoice("경비를 부르고 도주한다. (민책 12)", 'dex', 12, { message: "당신의 외침을 들은 경비병이 달려오자 노상강도는 혀를 차며 어둠 속으로 사라집니다.", action: () => {} }, { message: "소리를 지르기도 전에 노상강도가 앞을 막아섭니다! '어딜 가시나?'", action: () => game.startCombat(createRobber()) }), new Choice("전투한다.", () => game.startCombat(createRobber())) ], 'A dark back alley in a medieval city, a menacing robber ambushing a hero, fantasy art style.'),
